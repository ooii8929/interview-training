...
function App() {
  ...
  React.useEffect((e) => {
    ...
    if (!userId && sessionStorage.getItem("userid"))
      console.log("0. get user id by session storage run");
    ...
    <BrowserRouter>
      <AppContext.Provider value={appContextValue}>
        ...
        <Routes>
          ...
          <Route
            path="/course/video"
            element={<RequireAuth Component={CourseVideo} />}
          />
          <Route
            path="/course/code"
            element={<RequireAuth Component={CourseCode} />}
          />
          <Route
            path="/arrange"
            element={<RequireAuth Component={Arrange} />}
          />
