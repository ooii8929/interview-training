...
export default function Video(props) {
  ...
  const handleSave = async () => {
    ...
    try {
      let presignedUrl = await axios.get(
        "http://localhost:3001/api/1.0/training/video/answer/url",
        {
          params: {
            filename: file.name,
          },
      ...
      let submitAnswer = await axios.post(
        "http://localhost:3001/api/1.0/training/video/answer",
        data
      );
